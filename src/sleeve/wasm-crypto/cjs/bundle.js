...
exports.hmacSha512 = exports.hmacSha256 = exports.generateSleeve = exports.ed25519Verify = exports.ed25519Sign = exports.ed25519KeypairFromSeed = void 0;
...
const generateSleeve = withWasm((wasm, phrase) => {
  wasm.ext_generate_sleeve(8, ..._init.bridge.allocString(phrase));
  return _init.bridge.resultString();
});
exports.generateSleeve = generateSleeve;
